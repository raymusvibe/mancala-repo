...
public class NewGameRequestRuleTests {
    ...
    private Rule newGameRequestRule = new NewGameRequestRule();
    ...
    public void testValidationNewGame () throws Exception {
        ...
        assertDoesNotThrow(() -> {
            newGameRequestRule.processRequest(playerTwoNewGameMoveGame, Optional.of(playerTwoWinMoveGame), mancalaGamesMongoTemplate);
