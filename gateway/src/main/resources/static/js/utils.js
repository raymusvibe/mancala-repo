...
const player_one_button_arrow = document.getElementById("player_one_button_arrow");
const player_two_button = document.getElementById("player_two_button");
const player_two_button_arrow = document.getElementById("player_two_button_arrow");
...
function display_game_outcome() {
  remove_pot_handlers();
  let game_outcome_string;
  let winning_total = (game.winner == GameWinner.PLAYER_ONE)? game.mancalaBoard[player_one_house_index].stones : game.mancalaBoard[player_two_house_index].stones;

  if (game.winner == GameWinner.DRAW) {
    game_outcome_string = draw_message_string;
  ...
  game_status_message.innerHTML = game_outcome_string;
